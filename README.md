...
| [K07_left_join.R](https://github.com/cobriant/tidyverse_koans/blob/main/R/K07_left_join.R) | One more function from dplyr: use left_join() to combine two tibbles when you have a variable that acts as a key to match them. This koan sets learners up to solve [the dplyr murder mystery I adapted from here](https://github.com/speegled/dplyrmurdermystery/). This project has historically been a favorite: to quote my teaching evaluations, "The murder mystery proj was even enjoyable."|
...
| [K20_accumulate.R](https://github.com/cobriant/tidyverse_koans/blob/main/R/K20_accumulate.R) | I provide an example of how to use reduce() (and its relative accumulate()) to generate a random walk and then an autocorrelated series.|
