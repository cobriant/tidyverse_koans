...
#'
#'
#' Grading: Problem 7 will be graded out of 2 points.  
#' 
#'   *  0 ~ missing  
#'   *  1 ~ attempted but incomplete
#'   *  2 ~ well done
#'   *  2.2 ~ well done, applied less than five functions to reach the final answer
#'   *  2.5 ~ well done, used just one query to reach the final answer
#'   *  3 ~ superior, used just one query and less than five functions to reach the final answer
