...
#   Aesthetic mappings do just one simple thing: they take variables
#   (columns) in your data and map them to visual elements in your plot.
...
#    a facet layer, we "facet *by* continent". Make sure to take a look at
#    the plot.
...
#    differentiate between continents. So all the points in Africa will be
#    red, Europe will be blue, etc. This is an 'aes'thetic mapping because
#    we're taking a variable 'continent' and mapping it to the visual
#    element 'color'.
...
# 'color' is an aesthetic mapping which changes the color of the *outline*
#    of the geometry. If instead you want to change the color of the *fill*
#    of the geometry, use 'fill' instead of 'color'.
...
# In question 4, we specified an 'aes' in the 'ggplot()' call *and*
#   in the 'geom_point()' call. Something that's important to understand
#   is that layers like 'geom_point' which are added on to a ggplot call
#   will inherit the data and the aesthetic mappings from that initial
#   ggplot call by default.
...
# In this example, the geom_smooth() layer isn't drawn because it doesn't inherit
...
#   unnecessary repetition in code.
