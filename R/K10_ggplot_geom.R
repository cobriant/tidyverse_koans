...
# one by one. Keep in mind that you can use multiple 'geom's at a time by
...
# Note that you'll need to install gganimate and possibly some other dependencies.
# The animation will also take a few seconds to render, so be patient. For this
# problem, all you need to do is to un-comment the lines below and make sure
# you have everything installed so that an animation appears!
