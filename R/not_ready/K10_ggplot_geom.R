...
# In this koan, you'll practice using some of the most commonly used
...
# 12. Add a smoothed line layer to the plot you did above using geom_smooth().
...
# The visualization we made in 14) needs some work. The first issue is
# that a linear specification does not seem to fit very well. Let's try
...
# 16. The second issue is that there's over-plotting near the center. I'd like
...
# 17. Draw a line plot using 'geom_line'. Compare US 'gdpPercap' over
...
# 18. Draw a boxplot with geom_boxplot() that compares the
